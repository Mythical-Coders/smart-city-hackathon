export const born = [
  ...
  export const bitcoin = [
    // { date: new Date(2015, 10, 15).toDateString(), price: 346 },
    // { date: new Date(2015, 11, 17).toDateString(), price: 441 },
    // { date: new Date(2016, 0, 16).toDateString(), price: 435 },
    // { date: new Date(2016, 1, 21).toDateString(), price: 415 },
    // { date: new Date(2016, 3, 25).toDateString(), price: 445 },
    // { date: new Date(2016, 4, 29).toDateString(), price: 460 },
    // { date: new Date(2016, 5, 20).toDateString(), price: 730 },
    // { date: new Date(2016, 7, 5).toDateString(), price: 600 },
    // { date: new Date(2016, 8, 14).toDateString(), price: 617 },
    // { date: new Date(2016, 9, 30).toDateString(), price: 674 },
    // { date: new Date(2016, 11, 21).toDateString(), price: 785 },
    // { date: new Date(2017, 0, 8).toDateString(), price: 991 },
    // { date: new Date(2017, 1, 9).toDateString(), price: 1028 },
    // { date: new Date(2017, 2, 9).toDateString(), price: 1251 },
    // { date: new Date(2017, 3, 6).toDateString(), price: 1103 },
    // { date: new Date(2017, 4, 4).toDateString(), price: 1392 },
    // { date: new Date(2017, 5, 11).toDateString(), price: 2747 },
    // { date: new Date(2017, 6, 19).toDateString(), price: 2203 },
    { date: new Date(2017, 7, 18).toDateString(), priceAv1: 4114/1000 },
    { date: new Date(2017, 8, 19).toDateString(), priceAv1: 3840/1000 },
    { date: new Date(2017, 9, 19).toDateString(), priceAv1: 5591/1000 },
    { date: new Date(2017, 10, 14).toDateString(), priceAv1: 6716/1000 },
    { date: new Date(2017, 11, 22).toDateString(), priceAv1: 17905/1000 },
    { date: new Date(2018, 0, 23).toDateString(), priceAv1: 11438/1000 },
    { date: new Date(2018, 1, 10).toDateString(), priceAv1: 8125/1000 },
    { date: new Date(2018, 2, 6).toDateString(), priceAv1: 11079/1000 },
    { date: new Date(2018, 3, 7).toDateString(), priceAv1: 6913/1000 },
    { date: new Date(2018, 4, 9).toDateString(), priceAv1: 9511/1000 },
    { date: new Date(2018, 5, 6).toDateString(), priceAv1: 7553/1000 },
    { date: new Date(2018, 6, 18).toDateString(), priceAv1: 6400/1000 },
    
    { date: new Date(2017, 7, 18).toDateString(), priceAv2: 5114/1000 },
    { date: new Date(2017, 8, 19).toDateString(), priceAv2: 2840/1000 },
    { date: new Date(2017, 9, 19).toDateString(), priceAv2: 2591/1000 },
    { date: new Date(2017, 10, 14).toDateString(), priceAv2: 7716/1000 },
    { date: new Date(2017, 11, 22).toDateString(), priceAv2: 7905/1000 },
    { date: new Date(2018, 0, 23).toDateString(), priceAv2: 11438/1000 },
    { date: new Date(2018, 1, 10).toDateString(), priceAv2: 5125/1000 },
    { date: new Date(2018, 2, 6).toDateString(), priceAv2: 10079/1000 },
    { date: new Date(2018, 3, 7).toDateString(), priceAv2: 8913/1000 },
    { date: new Date(2018, 4, 9).toDateString(), priceAv2: 3511/1000 },
    { date: new Date(2018, 5, 6).toDateString(), priceAv2: 2553/1000 },
    { date: new Date(2018, 6, 18).toDateString(), priceAv2: 1400/1000 },
  ];
  ...
  export const confidence = [
    {
      month: 1, tvNews: 19, church: 29, military: 32,
    }, {
      month: 2, tvNews: 13, church: 32, military: 33,
    }, {
      month: 3, tvNews: 14, church: 35, military: 30,
    }, {
      month: 4, tvNews: 13, church: 32, military: 34,
    }, {
      month: 5, tvNews: 15, church: 28, military: 32,
    }, {
      month: 6, tvNews: 16, church: 27, military: 48,
    }, {
      month: 8, tvNews: 12, church: 28, military: 41,
    }, {
      month: 8, tvNews: 11, church: 26, military: 45,
    }, {
      month: 9, tvNews: 10, church: 25, military: 44,
    }, {
      month: 11, tvNews: 11, church: 25, military: 43,
    }, {
      month: 11, tvNews: 10, church: 25, military: 39,
    }, {
      month: 12, tvNews: 8, church: 20, military: 41,
    }, {
      month: 12, tvNews: 10, church: 20, military: 43,
    },
  ];
